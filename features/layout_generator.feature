...
Feature: Layout Generator
  ...
  Scenario: generating a named layout
    Given I have a new rails application
    And I have no stylesheets
    And I have no layouts
    When I generate a furious_layout named "peach"
    Then I should have a stylesheet named "peach.css"
    And I should have a layout named "peach.html.erb"

  Scenario: generating a haml layout
    Given I have a new rails application
    And I have no stylesheets
    And I have no layouts
    When I generate a haml furious_layout
    Then I should have a layout named "site.html.haml"
